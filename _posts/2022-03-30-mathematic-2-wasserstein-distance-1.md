...
*Earth-Mover distance* tương ứng với công của plan có chi phí nhỏ nhất.
{: .text-justify}
...
ngẫu nhiên đồng nhất từ $U[0, 1]$. Xét các họ phân phối sinh $P_{\theta}$ dạng $P_{\theta}=(\theta, y)$, $y$ cũng từ $U[0, 1]$.
